...
\name{Peter}{Vlk}
\position{Clojure Developer{\enskip\cdotp\enskip}Software Engineer}
\address{Mlynarovičova 13, 851 03, Bratislava, Slovakia}

\mobile{+421 908 202 241}
\email{petervlk86@gmail.com}
